...
$RUN -g 'b[lr]' -i tests/inputs/movies2.csv > $OUT/movies2.csv.grep.regex.insensitive.out
$RUN -l 0 -g 'b[lr]' -i tests/inputs/movies2.csv > $OUT/movies2.csv.grep.regex.insensitive.limit.0.out
